...
export class AdminDrives implements OnInit {
  ...
  onThisMonthToggle() {
    this.filterThisMonth = !this.filterThisMonth;
    if (this.filterThisMonth) {
      this.filterNextMonth = false;
      this.setThisMonth();
    } else {
  ...
  onNextMonthToggle() {
    this.filterNextMonth = !this.filterNextMonth;
    if (this.filterNextMonth) {
  ...
  applyDateFilter() {
    ...
    this.filteredDrives = this.drives.filter(
      (drive) => {
